...
fn main() {
    // Get executable path and set working directory
    let exe_path = env::current_exe().expect("Failed to get executable path");
    let project_root = exe_path
        .parent().unwrap()  // bin/<os>
        .parent().unwrap()  // bin
    ...
    // Validate paths
    let video_path = "assets/video.mov";
    ...
    // Handle result
    if status.success() {
        println!("✅ Conversion successful! PNGs saved to output/");
    } else {
